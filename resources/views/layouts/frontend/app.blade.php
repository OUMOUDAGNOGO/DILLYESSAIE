...
<html lang="en">
   <head>
      ...
      <!-- site metas -->
      <title>{{env('APP_NAM')}} | page d'accueil</title>
            ...
            <div class="header_top d_none1">
               <div class="container">
                  <div class="row">
                     <div class="col-md-4">
                        <ul class="conta_icon ">
                           <li><a href="#"><img src="images/call.png" alt="#"/>Appelez au : 90697626</a> </li>
                        </ul>
                     </div>
                     <div class="col-md-4">
                           ...
                           <form action="#" >
                              <div class="select-box">
                                 ...
                                 <select id="select-box1" class="select">
                                    <option value="Choice 1">Anglais</option>
         ...
         <div class="footer">
            ...
            <div class="copyright">
               <div class="container">
                  <div class="row">
                     <div class="col-md-12">
                        <p>© 2022 All Rights Reserved. Design by<a href="oumshouse">oumshouse</a></p>
                     </div>
                  </div>
               </div>
            </div>
